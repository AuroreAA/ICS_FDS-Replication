...
def expectation_y_2(ind2, mu_y_groups, eps, k):
    ...
    exp = 0
    for i in range(k):
        exp += eps[i] * expectation_x_2(mu=mu_y_groups[i][ind2], sigma=0)
    return exp
...
def expectation_y_4(ind4, mu_y_groups, eps, k):
    ...
    exp = 0
    for i in range(k):
        exp += eps[i] * expectation_x_4(mu=mu_y_groups[i][ind4], sigma=0)
    return exp
...
def expectation_y_3_1(ind3, ind1, mu_y_groups, eps, k):
    ...
    exp = 0
    for i in range(k):
        exp += eps[i] * expectation_x_3(mu=mu_y_groups[i][ind3], sigma=0) * expectation_x(mu=mu_y_groups[i][ind1])
    return exp
...
def expectation_y_2_2(ind2_a, ind2_b, mu_y_groups, eps, k):
    ...
    exp = 0
    for i in range(k):
        exp += eps[i] * expectation_x_2(mu=mu_y_groups[i][ind2_a], sigma=0) * expectation_x_2(mu=mu_y_groups[i][ind2_b], sigma=0)
    return exp
...
def expectation_y_2_1_1(ind2, ind1_a, ind1_b, mu_y_groups, eps, k):
    ...
    for i in range(k):
        exp += (eps[i] *
                expectation_x_2(mu=mu_y_groups[i][ind2], sigma=0) *
